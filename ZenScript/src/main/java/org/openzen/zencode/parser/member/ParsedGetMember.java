...
import org.openzen.zencode.symbolic.member.GetMember;
 ...
 * @author Stan
 */
public class ParsedGetMember implements IParsedMember
{
	...
	{
		return new GetMember<E, T>(this, scope);
	}
}
