...
import org.openzen.zencode.symbolic.member.definition.GetterMember;
 ...
 * @author Stan
 */
public class ParsedGetter implements IParsedMember
{
	...
	{
		return new GetterMember<E>(this, scope);
	}
}
