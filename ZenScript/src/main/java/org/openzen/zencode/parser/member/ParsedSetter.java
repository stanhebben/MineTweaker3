...
import org.openzen.zencode.symbolic.member.definition.SetterMember;
 ...
 * @author Stan
 */
public class ParsedSetter implements IParsedMember
{
	...
	{
		return new SetterMember<E>(this, scope);
	}
}
