...
public class DefinitionParser
{
	...
	public static IParsedDefinition parse(
			ZenLexer lexer,
	...
	private static IParsedDefinition parseStruct(
			ZenLexer lexer,
			List<ParsedAnnotation> annotations,
			List<IParsedModifier> modifiers)
	{
		CodePosition position = lexer.required(T_STRUCT, "struct exception").getPosition();
	...
	private static IParsedDefinition parseClassOrInterface(
			ZenLexer lexer,
			List<ParsedAnnotation> annotations,
			List<IParsedModifier> modifiers)
	{
	...
	private static IParsedDefinition parseEnum(
			ZenLexer lexer,
			List<ParsedAnnotation> annotations,
			List<IParsedModifier> modifiers)
	{
	...
	private static IParsedDefinition parseFunction(
			ZenLexer lexer,
			List<ParsedAnnotation> annotations,
			List<IParsedModifier> modifiers)
	{
	...
	private static IParsedDefinition parseExpansion(
			ZenLexer lexer,
			List<ParsedAnnotation> annotations,
			List<IParsedModifier> modifiers)
	{
