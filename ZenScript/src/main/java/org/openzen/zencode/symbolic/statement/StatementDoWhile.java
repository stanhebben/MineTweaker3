 ...
 * @param <T>
 */
public class StatementDoWhile<E extends IPartialExpression<E, T>, T extends IZenType<E, T>> extends Statement<E, T>
{
	private final E condition;
	private Statement<E, T> contents;

	public StatementDoWhile(CodePosition position, IScopeMethod<E, T> environment, E condition)
	{
