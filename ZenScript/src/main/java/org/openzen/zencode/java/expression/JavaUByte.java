 ...
 * @author Stan
 */
public class JavaUByte extends AbstractJavaExpression
{
	private final int value;
	
	public JavaUByte(CodePosition position, IMethodScope<IJavaExpression> scope, int value)
	{
	...
	{
		return getScope().getTypeCompiler().ubyte;
	}
