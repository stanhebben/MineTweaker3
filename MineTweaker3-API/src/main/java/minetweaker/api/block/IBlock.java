...
/**
 * Block interface. Used to interact with blocks in the world as well as a means
 * to define new blocks.
 *
 * @author Stan Hebben
 */
...
public interface IBlock extends IBlockPattern
{
	...
	/**
	 * Gets the light emitted by this block. Returns an ARGB value, with A =
	 * light strength. Color might or might not be ignored depending on the
